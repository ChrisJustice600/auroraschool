...
const HeroSection: React.FC = () => {
  ...
  const slides: Slide[] = [
    {
      title: "Bienvenue à l'École Innovante",
      description: "Formez-vous pour l'avenir avec nos programmes d'excellence",
      image:
    ...
    {
      title: "Apprenez, Innovez, Réussissez",
      description: "Des méthodes pédagogiques innovantes pour votre réussite",
      image:
    ...
    },
    {
      ...
      description: "Un accompagnement personnalisé pour votre orientation",
      image:
        ...
        >
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="text-center text-white px-4">
              <h1 className="text-2xl md:text-6xl  mb-4 slide-in font-caption">
                {slide.title}
              </h1>
              ...
              <a
                href={slide.link}
                className="bg-purple-600 hover:bg-purple-700 text-white font-bold py-3 px-6 rounded-full text-lg transition duration-300 ease-in-out transform hover:scale-105 slide-in"
              >
                {slide.cta}
              </a>
            </div>
